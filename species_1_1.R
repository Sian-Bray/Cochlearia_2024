...
go <- readMappings(file="/gpfs01/home/sbzsmb/GO_Permutation_Test/Input_Materials/Cochlearia_Thaliana_GO_universe_restrictive.tsv", 
                   sep = "	", IDsep = ",")

# All the genes in my scan (i.e. all the genes in regions from the bpm file)
genesInScan <- read.csv("/gpfs01/home/sbzsmb/GO_Permutation_Test/Input_Materials/genes_in_scan_clean.txt", 
                        header = FALSE)

# My genes of interest (i.e. Fst top 1%)
top1perc <- read.csv("/gpfs01/home/sbzsmb/GO_Permutation_Test/True10000/random_genes_species1_round1.txt", 
                     header = FALSE)
...
write.csv(allResBP, "/gpfs01/home/sbzsmb/GO_Permutation_Test/True10000/allResBP_species_1_1.csv")
write.csv(allResCC, "/gpfs01/home/sbzsmb/GO_Permutation_Test/True10000/allResCC_species_1_1.csv")
write.csv(allResMF, "/gpfs01/home/sbzsmb/GO_Permutation_Test/True10000/allResMF_species_1_1.csv")
